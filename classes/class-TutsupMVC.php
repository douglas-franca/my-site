...
class TutsupMVC
{
    ...
    public function __construct()
    {
        ...
        if (!$this->controlador) {
            // Adiciona o controlador padrão
            require_once ABSPATH . '/controllers/services-controller.php';

            // Cria o objeto do controlador "home-controller.php"
            // Este controlador deverá ter uma classe chamada HomeController
            $this->controlador = new ServicesController();
        ...
        // Inclui o arquivod do controlador
